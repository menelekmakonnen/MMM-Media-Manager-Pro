...
import ProBridgeActions from "../../components/ProBridgeActions";
const SettingsTab = () => {
  ...
  /* Pro Bridge Panel */
  /* @__PURE__ */ React.createElement("div", { className: "p-6 rounded-2xl bg-gradient-to-br from-indigo-500/5 to-purple-500/5 border border-indigo-500/15 relative overflow-hidden" },
    /* @__PURE__ */ React.createElement("div", { className: "absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-indigo-500/30 to-transparent" }),
    /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-white/40 mb-4 tracking-wider uppercase" }, "MMMedia Pro Bridge"),
    /* @__PURE__ */ React.createElement(BridgeStatus, null),
    /* @__PURE__ */ React.createElement("div", { className: "mt-4" },
      /* @__PURE__ */ React.createElement(ProBridgeActions, { layout: "column" })
    )
  ),
